...
-- Volcando datos para la tabla orion.game: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla orion.posts: ~2 rows (aproximadamente)
...
INSERT INTO `users` (`id`, `email`, `username`, `password`, `role`, `profile_pic`, `motd`, `badge_id`, `created_at`) VALUES
	(1, 'admin@togetheronorion.com', 'Orion', '$2y$10$jzNZPi0NpZoyB/VaJZkar.FVvw0YfUVT9CTgyuhJZt6lrxR.6wCZa', 1, NULL, 'Orion\'s official account', NULL, '2024-10-30 15:24:12');
