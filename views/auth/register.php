      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" novalidate id="registerForm">
          <div>
            ...
            <div class="mt-2">
              <input id="emailAddress" name="emailAddress" type="email" autocomplete="email" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
            </div>
            <span id="emailAddressError" class="mt-2 block text-sm/6 font-medium text-red-500"></span>
          </div>
