...
<p>To help explain things as clearly as possible in this Cookie Policy, every time any of these terms are referenced, are strictly defined as:</p>
 <ul>
   ...
   <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Orion, that is responsible for your information under this Cookie Policy.</li>
...
<h1 class="font-bold text-2xl mt-5">Introduction</h1>
<p>This Cookie Policy explains how Orion and its affiliates (collectively "Orion", "we", "us", and "ours"), use cookies and similar technologies to recognize you when you visit our website, including without limitation https://www.togetheronorion.com and any related URLs, mobile or localized versions and related domains / sub-domains ("Websites"). It explains what these technologies are and why we use them, as well as the choices for how to control them.</p>

<h1 class="font-bold text-2xl mt-5">What is a cookie?</h1>
...
<h1 class="font-bold text-2xl mt-5">Why do we use cookies?</h1>
...
<h1 class="font-bold text-2xl mt-5">What type of cookies does Orion use?</h1>
...
<h1 class="font-bold text-lg mt-2">Essential Cookies</h1>
...
<h1 class="font-bold text-lg mt-2">Performance and Functionality Cookies</h1>
...
<h1 class="font-bold text-lg mt-2">Analytics and Customization Cookies</h1>
...
<h1 class="font-bold text-lg mt-2">Third Party Cookies</h1>
<p>Some cookies that have been set on our website are not set on a first party basis by Orion. The Websites can be embedded with content from third parties to serve advertising. These third party service providers may set their own cookies on your web browser. Third party service providers control many of the performance and functionality, advertising, marketing and analytics cookies described above. We do not control the use of these third party cookies as cookies can only be accessed by the third party that originally set them.</p>
<h1 class="font-bold text-2xl mt-5">How you can manage cookies?</h1>
...
<h1 class="font-bold text-2xl mt-5">Changes To Our Cookie Policy</h1>
