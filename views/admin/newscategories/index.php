...
function showPage()
{
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-xl font-semibold text-alt">Categorías de noticias</h1>
      <a
        href="/admin/newscategories/new"
        id="add-entry"
      ...
      >
        ...
        <tbody>
          ...
          <tr class="border-t border-gray-700 hover:bg-[#1f2937] transition">
            ...
            <td class="px-4 py-3">
                <gradient-chip base-color="<?= $newscategory->tint ?>" size="25" text="<?= $newscategory->name ?>"></gradient-chip>
            </td>
